...
export default function DevicesPage() {
  ...
  const fetchEmergencyTriggers = async () => {
    try {
      const token = localStorage.getItem("access_token")
      const response = await fetch("http://localhost:8000/api/devices/triggers/", {
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
        },
  ...
  const handleRegisterDevice = async () => {
    try {
      const token = localStorage.getItem("access_token")
      const response = await fetch("http://localhost:8000/api/devices/register/", {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
  ...
  const acknowledgeEmergencyTrigger = async (triggerId: string) => {
    try {
      const token = localStorage.getItem("access_token")
      const response = await fetch(`http://localhost:8000/api/devices/triggers/${triggerId}/acknowledge/`, {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">Manage Guardian devices and monitor emergency situations</p>
            </div>
            <Dialog open={isRegisterDeviceOpen} onOpenChange={setIsRegisterDeviceOpen}>
              ...
              <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  ...
                  <DialogDescription>Register a new Guardian device for emergency monitoring</DialogDescription>
                </DialogHeader>
                <div className="space-y-4">
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setNewDevice((prev) => ({ ...prev, owner_name: e.target.value }))}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setNewDevice((prev) => ({ ...prev, owner_phone: e.target.value }))}
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      onChange={(e) => setNewDevice((prev) => ({ ...prev, owner_address: e.target.value }))}
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setNewDevice((prev) => ({ ...prev, emergency_contact: e.target.value }))}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setNewDevice((prev) => ({ ...prev, emergency_contact_phone: e.target.value }))}
                        placeholder="+265991234567"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="guardian_bracelet">Guardian Bracelet</SelectItem>
                        <SelectItem value="guardian_watch">Guardian Watch</SelectItem>
                        <SelectItem value="guardian_pendant">Guardian Pendant</SelectItem>
                        <SelectItem value="guardian_ring">Guardian Ring</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setNewDevice((prev) => ({ ...prev, blood_type: e.target.value }))}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setNewDevice((prev) => ({ ...prev, monitoring_interval: Number.parseInt(e.target.value) }))
                        }
                        placeholder="300"
                      />
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      onChange={(e) => setNewDevice((prev) => ({ ...prev, medical_conditions: e.target.value }))}
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      onChange={(e) => setNewDevice((prev) => ({ ...prev, medications: e.target.value }))}
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      onChange={(e) => setNewDevice((prev) => ({ ...prev, allergies: e.target.value }))}
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="flex items-center space-x-2">
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            setNewDevice((prev) => ({ ...prev, audio_monitoring_enabled: checked }))
                          }
                        />
                      ...
                      <div className="flex items-center space-x-2">
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            setNewDevice((prev) => ({ ...prev, heart_rate_monitoring_enabled: checked }))
                          }
                        />
                        <Label htmlFor="heart_rate_monitoring">Heart Rate Monitoring</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Switch
                          id="fire_monitoring"
                          ...
                          onCheckedChange={(checked) =>
                            setNewDevice((prev) => ({ ...prev, fire_monitoring_enabled: checked }))
                          }
                        />
                      ...
                      <div className="flex items-center space-x-2">
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            setNewDevice((prev) => ({ ...prev, fall_detection_enabled: checked }))
                          }
                        />
                  ...
                  <div className="flex gap-2 pt-4">
                    ...
                    <Button variant="outline" onClick={() => setIsRegisterDeviceOpen(false)}>
                      Cancel
                    </Button>
                  </div>
                </div>
                    ...
                    >
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          <Badge variant={getSeverityColor(trigger.severity) as any}>{trigger.severity}</Badge>
                          <span className="font-medium">{trigger.trigger_type.replace("_", " ")}</span>
                        </div>
                        <p className="text-sm text-muted-foreground">
                          {trigger.device_info.owner_name} - {trigger.device_info.serial_number}
                        </p>
                        <p className="text-xs text-muted-foreground">
                          {new Date(trigger.triggered_at).toLocaleString()}
                        </p>
                      </div>
                      <Button size="sm" onClick={() => acknowledgeEmergencyTrigger(trigger.trigger_id)}>
                        Acknowledge
                      </Button>
                    </div>
                  ))}
          ...
          <div className="grid gap-4 md:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{devices.filter((d) => d.is_online).length}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{unacknowledgedTriggers.length}</div>
                <p className="text-xs text-muted-foreground">Unacknowledged triggers</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <CardContent>
                <div className="text-2xl font-bold">{devices.filter((d) => d.battery_level < 20).length}</div>
                <p className="text-xs text-muted-foreground">Devices below 20%</p>
              </CardContent>
            </Card>
          </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Find devices by owner, serial number, or location</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage registered Guardian devices</CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <TableBody>
                    {filteredDevices.map((device) => (
                      <TableRow key={device.device_id}>
                        ...
                        <TableCell>
                          <div>
                            <div className="font-medium">{device.owner_name}</div>
                            <div className="text-sm text-muted-foreground">{device.owner_phone}</div>
                          </div>
                        </TableCell>
                        <TableCell>
                          <div className="flex items-center gap-2">
                            <Badge variant={getStatusColor(device.status) as any}>{device.status}</Badge>
                            {device.is_online ? (
                              <CheckCircle className="h-4 w-4 text-green-500" />
                            ) : (
          ...
          <Dialog open={isDeviceDetailsOpen} onOpenChange={setIsDeviceDetailsOpen}>
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>Detailed information about {selectedDevice?.serial_number}</DialogDescription>
              </DialogHeader>
              {selectedDevice && (
                <div className="space-y-4">
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm">{getDeviceTypeDisplay(selectedDevice.device_type)}</p>
                    </div>
                    <div>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div>
                      ...
                      <p className="text-sm">{selectedDevice.emergency_contact || "Not provided"}</p>
                    </div>
                    <div>
                      <Label className="text-sm font-medium">Emergency Phone</Label>
                      <p className="text-sm">{selectedDevice.emergency_contact_phone || "Not provided"}</p>
                    </div>
                  </div>

                  <div>
                    <Label className="text-sm font-medium">Medical Conditions</Label>
                    <p className="text-sm">{selectedDevice.medical_conditions || "None reported"}</p>
                  </div>

                  <div>
                    <Label className="text-sm font-medium">Medications</Label>
                    <p className="text-sm">{selectedDevice.medications || "None reported"}</p>
                  </div>

                  <div>
                    <Label className="text-sm font-medium">Allergies</Label>
                    <p className="text-sm">{selectedDevice.allergies || "None reported"}</p>
                  </div>

                  <div className="grid gap-4 md:grid-cols-2">
                    <div>
                      <Label className="text-sm font-medium">Blood Type</Label>
                      <p className="text-sm">{selectedDevice.blood_type || "Not provided"}</p>
                    </div>
                    <div>
                      <Label className="text-sm font-medium">Firmware Version</Label>
                      <p className="text-sm">{selectedDevice.firmware_version}</p>
                    </div>
                  </div>

                  <div>
                    <Label className="text-sm font-medium">Monitoring Settings</Label>
                  ...
                  <div>
                    ...
                    <p className="text-sm">{new Date(selectedDevice.registered_at).toLocaleString()}</p>
                  </div>
                </div>
              )}
            </DialogContent>
