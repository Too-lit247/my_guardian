        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Filter alerts by status, priority, or search terms</CardDescription>
            </CardHeader>
            <CardContent>
                      ...
                      <TableRow key={alert.id}>
                        <TableCell>
                          <div>
                            ...
                            <div className="text-sm text-muted-foreground">{alert.alert_type}</div>
                          </div>
                        </TableCell>
                        <TableCell>
                        ...
                        <TableCell>
                          <div className="text-sm">{alert.assigned_to || "Unassigned"}</div>
                        </TableCell>
                        <TableCell>
                          <div className="text-sm">{new Date(alert.created_at).toLocaleDateString()}</div>
                        </TableCell>
                        <TableCell>
