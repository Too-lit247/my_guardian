...
export default function NewAlertPage() {
  ...
  const teams = {
    fire: ["Fire Team Alpha", "Fire Team Beta", "Fire Team Gamma", "Hazmat Unit"],
    police: ["Police Unit 1", "Police Unit 2", "Police Unit 3", "SWAT Team"],
    medical: ["Ambulance Unit 1", "Ambulance Unit 2", "Ambulance Unit 3", "Emergency Response Team"],
  }
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Report a new emergency situation</p>
            </div>
          </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Fill in the details of the emergency situation. All fields are required.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {error && (
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={formData.priority} onValueChange={(value) => handleInputChange("priority", value)}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="medium">Medium - Urgent Response</SelectItem>
